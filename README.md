...
- [第十三周开发文档](docs/第十三周.md)
- [第十四周开发文档](docs/第十四周.md)
- [接口路由与前端功能](docs/接口路由与前端功能.md)
- [项目部署教程（自己动手版）](docs/项目部署教程.md)
...
数据库表由 Flyway 管理，当前版本为 `V12`。第十三周新增转发、治理关系、推荐反馈、趋势快照、任务审计、消费幂等、人工处理和审计归档表；V12 为全部 34 张业务表和 324 个字段补充中文数据库注释。V1～V12 是不可修改的历史迁移，后续结构变化必须新增 V13。完整字段、主外键、索引、ER 图和 Redis/MinIO/RabbitMQ/OpenSearch 数据边界见[数据库文档](docs/数据库文档.md)。
